document.addEventListener("DOMContentLoaded", function () {
    ...
    btnAdicionarList.forEach(function (btnAdicionar) {
        btnAdicionar.addEventListener("click", function () {
            ...
            var novoValor = valorAtual + 70.0; // Supondo que 70.0 é o custo de cada pizza
            resultadoFinalElement.textContent = novoValor.toFixed(2);
    
            // Armazene localmente os sabores selecionados e o valor total
            atualizarLocalStorage();
    
            // Verifique a quantidade de unidades selecionadas e role para o próximo subtítulo
    ...
    function atualizarLocalStorage() {
        ...
        unidades.forEach(function (unidade) {
            ...
            if (quantidade > 0) {
                ...
                var sabor = unidade.closest('.product').getAttribute('data-index');
        ...
        var valorTotal = parseFloat(document.querySelector(".resultadoFinal").textContent);
    
        // Armazenar no localStorage
        localStorage.setItem("saboresSelecionados", JSON.stringify(saboresSelecionados));
